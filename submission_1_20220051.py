...
def submission_1_20220051(yaml_path, output_json_path):
    ...
    ex_dict['Model']=model
    ex_dict = YOLO11n.train_model(ex_dict)
    test_images = get_test_images(data_config)
    results_dict = YOLO11n.detect_and_save_bboxes(ex_dict['Model'], test_images, confidence)
